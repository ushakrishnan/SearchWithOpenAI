...
#os.environ["OPENAI_API_BASE"]=OPENAI_API_BASE="https://oaiuk.openai.azure.com"
#os.environ["OPENAI_API_KEY"] = OPENAI_API_KEY = os.environ["AZ_OPENAI_API_KEY"]
sys.exit

# Create instance of OpenAI LLM
llm = AzureOpenAI(openai_api_base=OPENAI_API_BASE , model="text-davinci-003", temperature=0.1, verbose=True, deployment_name="davinci", openai_api_key=OPENAI_API_KEY)

#get document store
store = getfromstore(collection_name="sou_coll")
#print(store1.get(["metadatas"]))

resp = llm("Tell me indian joke")
print(resp)
print("------------")
st.write(resp)
st.write("----------------------")
